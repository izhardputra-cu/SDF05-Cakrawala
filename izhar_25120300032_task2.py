"""
Refleksi:
Saya mengganti nama fungsi f menjadi calculate_order_total supaya tujuan fungsinya lebih jelas.
Saya juga mengganti nama variabel yang masih satu huruf menjadi nama yang sesuai dengan isinya.
Fungsi utama saya pecah menjadi beberapa fungsi kecil supaya lebih mudah dibaca dan diperbaiki.
"""
